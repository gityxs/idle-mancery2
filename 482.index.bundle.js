/*! For license information please see 482.index.bundle.js.LICENSE.txt */
"use strict";
(self.webpackChunkidlemancery2 = self.webpackChunkidlemancery2 || []).push([
  [482],
  {
    482: (n, e, i) => {
      i.d(e, { Z: () => In });
      ...
      function F(n) {
        ...
        if (t > 0) {
          for (s += o, e = 1; e < t; e++)
            (i = 7 - (r = n[e] + "").length) && (s += U(i)), (s += r);
          (i = 7 - (r = (o = n[e]) + "").length) && (s += U(i));
        ...
        return (
          ...
          null == r
            ? e < 3
              ...
              : (o =
                  (((i < 4 && u + 1 == s) || (i > 3 && u + 1 == s / 2)) &&
                    ((n[t + 1] / s / 100) | 0) == v(10, e - 2) - 1) ||
                  ((u == s / 2 || 0 == u) && 0 == ((n[t + 1] / s / 100) | 0)))
            : e < 4
            ? (0 == e
                ? (u = (u / 1e3) | 0)
                : 1 == e
            ...
            : (o =
                (((r || i < 4) && u + 1 == s) ||
                  (!r && i > 3 && u + 1 == s / 2)) &&
                ((n[t + 1] / s / 1e3) | 0) == v(10, e - 3) - 1),
          o
        );
      }
      function D(n, e, i) {
        for (var r, t, s = [0], o = 0, c = n.length; o < c; ) {
          for (t = s.length; t--; ) s[t] *= e;
          for (s[0] += u.indexOf(n.charAt(o++)), r = 0; r < s.length; r++)
            s[r] > i - 1 &&
      ...
      (O.absoluteValue = O.abs =
        ...
        (O.comparedTo = O.cmp =
          function (n) {
            ...
            for (e = 0, i = (r = o.length) < (t = u.length) ? r : t; e < i; ++e)
              ...
              ? i.d[0]
                ? ((n = r.precision),
                  ...
                  (i = (function (n, e) {
                    ...
                    (r = e.d.length) < 32
                      ? (t = (1 / z(4, (i = Math.ceil(r / 3)))).toString())
                      : ((i = 16), (t = "2.3283064365386962890625e-10")),
                      (n.precision += i),
                      (e = J(n, 1, e.times(t), new n(1)));
                    for (var s = i; s--; ) {
                      var o = e.times(e);
          ...
          function () {
            ...
            for (
              ...
              if (
                ...
                (r = S(f.plus(a).times(u), f.plus(c), o + 2, 1)),
                F(u.d).slice(0, o) === (i = F(r.d)).slice(0, o))
              ) {
                if (
                  ...
                  (+i && (+i.slice(1) || "5" != i.charAt(0))) ||
                    (k(r, n + 1, 1), (e = !r.times(r).times(r).eq(a)));
                  break;
                }
                if (!t && (k(u, n + 1, 0), u.times(u).times(u).eq(a))) {
                  r = u;
                  break;
                }
                (o += 4), (t = 1);
              }
            return (h = !0), k(r, n, d.rounding, e);
          }),
        ...
        (O.dividedToIntegerBy = O.divToInt =
          function (n) {
            ...
            return k(S(this, new e(n), 0, 1, 1), e.precision, e.rounding);
          }),
        (O.equals = O.eq =
          function (n) {
            return 0 === this.cmp(n);
        ...
        (O.hyperbolicCosine = O.cosh =
          function () {
            ...
            (i = o.precision),
              ...
              (o.rounding = 1),
              (t = s.d.length) < 32
                ? (e = (1 / z(4, (n = Math.ceil(t / 3)))).toString())
            ...
            return k(s, (o.precision = i), (o.rounding = r), !0);
          }),
            ...
            return i.isFinite()
              ? i.isZero()
                ...
                : ((n = r.precision),
                  ...
                  (r.precision = n + 7),
                  (r.rounding = 1),
                  S(i.sinh(), i.cosh(), (r.precision = n), (r.rounding = e)))
              : new r(i.s);
          }),
              ...
              ? t.e >= 0
                ...
                : ((n = s.precision),
                  ...
                  Math.max(r, n) < 2 * -t.e - 1
                    ? k(new s(t), n, e, !0)
                    : ((s.precision = i = r - t.e),
                      (t = S(t.plus(1), new s(1).minus(t), i + n, 1)),
                      (s.precision = n + 4),
                      (s.rounding = 1),
                      (t = t.ln()),
                      (s.precision = n),
        ...
        (O.inverseTangent = O.atan =
          function () {
            ...
            if (f.isFinite()) {
              ...
              if (d + 4 <= q)
                return ((o = _(a, d + 4, l).times(0.5)).s = f.s), o;
            }
            for (
              a.precision = u = d + 10,
                a.rounding = 1,
            ...
            return (
              i && (o = o.times(2 << (i - 1))),
              (h = !0),
              k(o, (a.precision = d), (a.rounding = l), !0)
            );
          }),
        (O.isFinite = function () {
          return !!this.d;
        ...
        (O.minus = O.sub =
          function (n) {
            var e,
              ...
              g = this,
              p = g.constructor;
            if (((n = new p(n)), !g.d || !n.d))
              return (
                g.s && n.s
                  ? g.d
                    ? (n.s = -n.s)
                    : (n = new p(n.d || g.s !== n.s ? g : NaN))
                  : (n = new p(NaN)),
                n
              );
            ...
            if (
              ((i = m(n.e / 7)), (a = m(g.e / 7)), (f = f.slice()), (s = a - i))
            ) {
              for (
                (d = s < 0)
                  ? ((e = f), (s = -s), (o = l.length))
              ...
              for (
                (d = (r = f.length) < (o = l.length)) && (o = r), r = 0;
                r < o;
                r++
              )
                if (f[r] != l[r]) {
          ...
          function (n) {
            ...
            return (
              ...
              !i.d || !n.s || (n.d && !n.d[0])
                ? new r(NaN)
                : !n.d || (i.d && !i.d[0])
                ? k(new r(i), r.precision, r.rounding)
                : ((h = !1),
                  9 == r.modulo
                    ? ((e = S(i, n.abs(), 0, 3, 1)).s *= n.s)
                    : (e = S(i, n, 0, r.modulo, 1)),
                  (e = e.times(n)),
                  (h = !0),
                  i.minus(e))
            );
        ...
        (O.plus = O.add =
          function (n) {
            ...
            if (
              ...
              return a[0] || (n = new l(d)), h ? k(n, u, c) : n;
            if (
              ((s = m(d.e / 7)), (r = m(n.e / 7)), (f = f.slice()), (t = s - r))
            ) {
              for (
                t < 0
                  ? ((i = f), (t = -t), (o = a.length))
            ...
            for (
              ...
              (e = ((f[--t] = f[t] + a[t] + e) / y) | 0), (f[t] %= y);
            for (e && (f.unshift(e), ++r), o = f.length; 0 == f[--o]; ) f.pop();
            return (n.d = f), (n.e = R(f, r)), h ? k(n, u, c) : n;
          }),
        (O.precision = O.sd =
          function (n) {
            var e,
              ...
              ? i.isZero()
                ...
                : ((n = r.precision),
                  ...
                  (i = (function (n, e) {
                    var i,
                      r = e.d.length;
                    if (r < 3) return e.isZero() ? e : J(n, 2, e, e);
                    (i = (i = 1.4 * Math.sqrt(r)) > 16 ? 16 : 0 | i),
                      (e = J(n, 2, (e = e.times(1 / z(5, i))), e));
                    for (
        ...
        (O.squareRoot = O.sqrt =
          function () {
            ...
            for (
              ...
              if (
                ((r = (s = r).plus(S(o, s, i + 2, 1)).times(0.5)),
                F(s.d).slice(0, i) === (e = F(r.d)).slice(0, i))
              ) {
                if (
                  ...
                  (+e && (+e.slice(1) || "5" != e.charAt(0))) ||
                    (k(r, c + 1, 1), (n = !r.times(r).eq(o)));
                  break;
                }
                if (!t && (k(s, c + 1, 0), s.times(s).eq(o))) {
                  r = s;
                  break;
                }
                (i += 4), (t = 1);
              }
            return (h = !0), k(r, c, a.rounding, n);
          }),
        (O.tangent = O.tan =
          function () {
            var n,
            ...
            return i.isFinite()
              ? i.isZero()
                ...
                : ((n = r.precision),
                  ...
                  (r.rounding = 1),
                  ((i = i.sin()).s = 1),
                  (i = S(i, new r(1).minus(i.times(i)).sqrt(), n + 10, 0)),
                  (r.precision = n),
                  (r.rounding = e),
                  k(2 == t || 4 == t ? i.neg() : i, n, e, !0))
              : new r(NaN);
          }),
        (O.times = O.mul =
          function (n) {
            ...
            for (
              i = m(a.e / 7) + m(n.e / 7),
                (c = l.length) < (f = g.length) &&
                  ((s = l), (l = g), (g = s), (o = c), (c = f), (f = o)),
                s = [],
                r = o = c + f;
              r--;
            ...
            return (
              ...
              (n.d = s),
              (n.e = R(s, i)),
              h ? k(n, d.precision, d.rounding) : n
            );
          }),
        ...
        (O.toExponential = function (n, e) {
          ...
          return (
            void 0 === n
              ? (i = P(r, !0))
              : (Z(n, 0, o),
                void 0 === e ? (e = t.rounding) : Z(e, 0, 8),
                (i = P((r = k(new t(r), n + 1, e)), !0, n + 1))),
        ...
        (O.toFixed = function (n, e) {
          ...
          return (
            void 0 === n
              ? (i = P(t))
              : (Z(n, 0, o),
                void 0 === e ? (e = s.rounding) : Z(e, 0, 8),
                (i = P((r = k(new s(t), n + t.e + 1, e)), !1, n + r.e + 1))),
        ...
        (O.toFraction = function (n) {
          ...
          if (
            ((f = i = new m(1)),
            (r = c = new m(0)),
            (o = (s = (e = new m(r)).e = L(w) - p.e - 1) % 7),
            (e.d[0] = v(10, o < 0 ? 7 + o : o)),
            null == n)
          )
            n = s > 0 ? e : f;
          else {
            if (!(u = new m(n)).isInt() || u.lt(f)) throw Error(l + u);
            n = u.gt(e) ? (s > 0 ? e : f) : u;
          }
          for (
            h = !1,
            ...
            (d = S(u, e, 0, 1, 1)), 1 != (t = i.plus(d.times(r))).cmp(n);
            ...
            (i = r),
              ...
              (u = t);
          return (
            (t = S(n.minus(i), r, 0, 1, 1)),
            (c = c.plus(t.times(f))),
            (i = i.plus(t.times(r))),
            (c.s = f.s = p.s),
            (g =
              S(f, r, s, 1).minus(p).abs().cmp(S(c, i, s, 1).minus(p).abs()) < 1
                ? [f, r]
                : [c, i]),
            (m.precision = a),
            (h = !0),
        ...
        (O.toNearest = function (n, e) {
          ...
          return (
            n.d[0]
              ? ((h = !1), (i = S(i, n, 0, e, 1).times(n)), (h = !0), k(i))
              : ((n.s = i.s), (i = n)),
            i
          );
        }),
        ...
        (O.toPower = O.pow =
          function (n) {
            ...
            if (((r = c.precision), (s = c.rounding), n.eq(1)))
              return k(u, r, s);
            if (
              (e = m(n.e / 7)) >= n.d.length - 1 &&
              (i = f < 0 ? -f : f) <= 9007199254740991
            )
              return (
                (t = C(c, u, i, r)), n.s < 0 ? new c(1).div(t) : k(t, r, s)
              );
            if ((o = u.s) < 0) {
            ...
            return (e =
              0 != (i = v(+u, f)) && isFinite(i)
                ? new c(i + "").e
                : m(f * (Math.log("0." + F(u.d)) / Math.LN10 + u.e + 1))) >
              c.maxE + 1 || e < c.minE - 1
              ? new c(e > 0 ? o / 0 : 0)
              : ((h = !1),
                (c.rounding = u.s = 1),
                (i = Math.min(12, (e + "").length)),
                (t = B(n.times(V(u, r + i)), r)).d &&
                  A((t = k(t, r + 5, 1)).d, r, s) &&
                  ((e = r + 10),
                  +F((t = k(B(n.times(V(u, e + i)), e), e + 5, 1)).d).slice(
                    r + 1,
                    r + 15
                  ) +
                    1 ==
        ...
        (O.toPrecision = function (n, e) {
          ...
          return (
            void 0 === n
              ? (i = P(r, r.e <= t.toExpNeg || r.e >= t.toExpPos))
              : (Z(n, 1, o),
                void 0 === e ? (e = t.rounding) : Z(e, 0, 8),
                (i = P(
                  (r = k(new t(r), n, e)),
          ...
          function (n, e) {
            ...
            return (
              void 0 === n
                ...
                : (Z(n, 1, o), void 0 === e ? (e = i.rounding) : Z(e, 0, 8)),
              k(new i(this), n, e)
            );
          }),
        (O.toString = function () {
          var n = this,
            e = n.constructor,
            i = P(n, n.e <= e.toExpNeg || n.e >= e.toExpPos);
      ...
      var S = (function () {
        ...
        return function (t, s, o, u, c, f) {
          ...
          if (
            (_[d] > (T[d] || 0) && h--,
            null == o
              ? ((q = o = P.precision), (u = P.rounding))
              : (q = c ? o + (t.e - s.e) + 1 : o),
            q < 0)
          )
            b.push(1), (p = !0);
          else {
            if (((q = (q / g + 2) | 0), (d = 0), 1 == D)) {
              for (l = 0, _ = _[0], q++; (d < Z || l) && q--; d++)
                (O = l * f + (T[d] || 0)),
                  (b[d] = (O / _) | 0),
                  (l = O % _ | 0);
              p = l || d < Z;
              ...
              for (
                (l = (f / (_[0] + 1)) | 0) > 1 &&
                  ...
                  (Z = T.length)),
                  F = D,
                  x = (E = T.slice(0, D)).length;
                x < D;

              )
                E[x++] = 0;
              (S = _.slice()).unshift(0), (A = _[0]), _[1] >= f / 2 && ++A;
              do {
                (l = 0),
                  (a = e(_, E, D, x)) < 0
                    ? ((M = E[0]),
                      ...
                      (l = (M / A) | 0) > 1
                        ...
                        : (0 == l && (a = l = 1), (w = _.slice())),
                      (v = w.length) < x && w.unshift(0),
                      i(E, w, x, f),
                      -1 == a &&
                        (a = e(_, E, D, (x = E.length))) < 1 &&
                        (l++, i(E, D < x ? S : _, x, f)),
                      (x = E.length))
                    : 0 === a && (l++, (E = [0])),
                  (b[d++] = l),
                  a && E[0] ? (E[x++] = T[F] || 0) : ((E = [T[F]]), (x = 1));
              } while ((F++ < Z || void 0 !== E[0]) && q--);
              p = void 0 !== E[0];
            }
            b[0] || b.shift();
          }
          if (1 == g) (N.e = h), (r = p);
            ...
            (N.e = d + h * g - 1), k(N, c ? o + N.e + 1 : o, u, p);
          }
          return N;
        };
      })();
      function k(n, e, i, r) {
        ...
        n: if (null != e) {
          if (!(d = n.d)) return n;
          for (t = 1, u = d[0]; u >= 10; u /= 10) t++;
          if ((s = e - t) < 0)
            (s += 7),
              (o = e),
              (c = ((a = d[(l = 0)]) / v(10, t - o - 1)) % 10 | 0);
          else if ((l = Math.ceil((s + 1) / 7)) >= (u = d.length)) {
            if (!r) break n;
            for (; u++ <= l; ) d.push(0);
            (a = c = 0), (t = 1), (o = (s %= 7) - 7 + 1);
          } else {
            for (a = u = d[l], t = 1; u >= 10; u /= 10) t++;
            c =
              (o = (s %= 7) - 7 + t) < 0 ? 0 : (a / v(10, t - o - 1)) % 10 | 0;
          }
          if (
            ((r =
              r ||
          ...
          if (
            (0 == s
              ...
              : ((d.length = l + 1),
                (u = v(10, 7 - s)),
                (d[l] = o > 0 ? ((a / v(10, t - o)) % v(10, o) | 0) * u : 0)),
            f)
          )
            for (;;) {
              if (0 == l) {
      ...
      function T(n, e, i) {
        if (e > M) throw ((h = !0), i && (n.precision = i), Error(g));
      ...
      function B(n, e) {
        ...
        for (
          null == e ? ((h = !1), (c = p)) : (c = e), u = new l(0.03125);
          n.e > -2;

        )
          (n = n.times(u)), (d += 5);
        for (
          c += r = ((Math.log(v(2, d)) / Math.LN10) * 2 + 5) | 0,
            i = s = o = new l(1),
            l.precision = c;
          ;
          ...
          if (
            ((s = k(s.times(n), c, 1)),
            (i = i.times(++a)),
            F((u = o.plus(S(s, i, c, 1))).d).slice(0, c) === F(o.d).slice(0, c))
          ) {
            for (t = d; t--; ) o = k(o.times(o), c, 1);
            if (null != e) return (l.precision = p), o;
            if (!(f < 3 && A(o.d, c - r, g, f)))
              return k(o, (l.precision = p), g, (h = !0));
      ...
      function V(n, e) {
        var i,
          ...
          v = m.rounding,
          N = m.precision;
        if (p.s < 0 || !w || !w[0] || (!p.e && 1 == w[0] && 1 == w.length))
          return new m(w && !w[0] ? -1 / 0 : 1 != p.s ? NaN : w ? 0 : p);
        if (
          (null == e ? ((h = !1), (a = N)) : (a = e),
          (m.precision = a += 10),
          (r = (i = F(w)).charAt(0)),
          ...
          return (
            (f = T(m, a + 2, N).times(s + "")),
            (p = V(new m(r + "." + i.slice(1)), a - 10).plus(f)),
            (m.precision = N),
            null == e ? k(p, N, v, (h = !0)) : p
          );
        for (; (r < 7 && 1 != r) || (1 == r && i.charAt(1) > 3); )
          (r = (i = F((p = p.times(n)).d)).charAt(0)), g++;
        for (
          s = p.e,
            r > 1
              ? ((p = new m("0." + i)), s++)
              : (p = new m(r + "." + i.slice(1))),
            d = p,
            c = o = p = S(p.minus(1), p.plus(1), a, 1),
            l = k(p.times(p), a, 1),
            t = 3;
          ;
          ...
          if (
            ((o = k(o.times(l), a, 1)),
            F((f = c.plus(S(o, new m(t), a, 1))).d).slice(0, a) ===
              F(c.d).slice(0, a))
          ) {
            if (
              ((c = c.times(2)),
              0 !== s && (c = c.plus(T(m, a + 2, N).times(s + ""))),
              (c = S(c, new m(g), a, 1)),
              null != e)
            )
              return (m.precision = N), c;
            if (!A(c.d, a - 10, v, u))
              return k(c, (m.precision = N), v, (h = !0));
            (m.precision = a += 10),
              (f = o = p = S(d.minus(1), d.plus(1), a, 1)),
              (l = k(p.times(p), a, 1)),
              (t = u = 1);
          }
          (c = f), (t += 2);
      ...
      function W(n, e) {
        var i, r, t, s, o, u, c, f, a;
        if (e.indexOf("_") > -1) {
          if (((e = e.replace(/(\d)_(?=\d)/g, "$1")), x.test(e)))
            return j(n, e);
        ...
        if (b.test(e)) (i = 16), (e = e.toLowerCase());
          ...
          if (!E.test(e)) throw Error(l + e);
          i = 8;
        }
        for (
          (s = e.search(/p/i)) > 0
            ? ((c = +e.slice(s + 1)), (e = e.substring(2, s)))
            : (e = e.slice(2)),
            o = (s = e.indexOf(".")) >= 0,
            r = n.constructor,
            o &&
        ...
        return s < 0
          ...
          : ((n.e = R(f, a)),
            ...
            (h = !1),
            o && (n = S(n, t, 4 * u)),
            c && (n = n.times(Math.abs(c) < 54 ? v(2, c) : Cn.pow(2, c))),
            (h = !0),
            n);
      }
      function J(n, e, i, r, t) {
        var s,
          o,
          u,
          c,
      ...
      function K(n, e, i, t) {
        ...
        if (
          (m
            ? (Z(i, 1, o), void 0 === t ? (t = w.rounding) : Z(t, 0, 8))
            : ((i = w.precision), (t = w.rounding)),
          n.isFinite())
        ) {
          for (
            m
              ? ((s = 2), 16 == e ? (i = 4 * i - 3) : 8 == e && (i = 3 * i - 2))
              : (s = e),
              (f = (l = P(n)).indexOf(".")) >= 0 &&
                ((l = l.replace(".", "")),
                ((p = new w(1)).e = l.length - f),
                (p.d = D(P(p), 10, s)),
                (p.e = p.d.length)),
              c = h = (g = D(l, 10, s)).length;
            0 == g[--h];
          ...
          if (g[0]) {
            ...
            for (f = 0, l = ""; f < h; f++) l += u.charAt(g[f]);
            if (m) {
              if (h > 1)
                if (16 == e || 8 == e) {
                  for (f = 16 == e ? 4 : 3, --h; h % f; h++) l += "0";
                  for (h = (g = D(l, s, e)).length; !g[h - 1]; --h);
                  for (f = 1, l = "1."; f < h; f++) l += u.charAt(g[f]);
      ...
      function un(n, e) {
        ...
        return (
          n.s && e.s
            ? n.d || e.d
              ? !e.d || n.isZero()
                ? ((i = e.s < 0 ? _(this, r, t) : new this(0)).s = n.s)
                : !n.d || e.isZero()
      ...
      function hn(n) {
        ...
        for (e = 0; e < u.length; e += 3)
          if (((i = u[e]), t && (this[i] = a[i]), void 0 !== (r = n[i]))) {
            if (!(m(r) === r && r >= u[e + 1] && r <= u[e + 2]))
              throw Error(l + i + ": " + r);
            this[i] = r;
          }
        if (((i = "crypto"), t && (this[i] = a[i]), void 0 !== (r = n[i]))) {
          if (!0 !== r && !1 !== r && 0 !== r && 1 !== r)
            throw Error(l + i + ": " + r);
          if (r) {
            if (
      ...
      function vn(n) {
        return n instanceof Cn || (n && n.toStringTag === w) || !1;
      }
      function Nn(n) {
      ...
      function Zn(n) {
        var e,
          ...
          c = [];
        if (
          (void 0 === n ? (n = this.precision) : Z(n, 1, o),
          (r = Math.ceil(n / 7)),
          this.crypto)
        )
      ...
      function Tn() {
        ...
        return (h = !0), k(i, this.precision, this.rounding);
      }
      function _n(n) {
      ...
      var Cn = (O.constructor = (function n(e) {
        var i, r, t;
        function s(n) {
          var e,
            i,
          ...
          if ("string" !== r) throw Error(l + n);
          return (
            45 === (i = n.charCodeAt(0))
              ? ((n = n.slice(1)), (t.s = -1))
              : (43 === i && (n = n.slice(1)), (t.s = 1)),
            x.test(n) ? j(t, n) : W(t, n)
          );
        }
        if (
          ((s.prototype = O),
